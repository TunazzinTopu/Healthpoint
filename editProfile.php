...
if (!empty($_POST)) {
    ...
    $sql = 'select * from doctors where doctorPhone = ' . $phoneNoNew;
    ...
    {
        $sql = 'update doctors set doctorName = "'.$nameNew.'", doctorPhone = "'.$phoneNoNew.'", doctorGender = "'.$genderNew.'" where doctorPhone= "'.$phoneNoNew.'"';
        ...
        if ($resultInsert) {
          ...
          $_SESSION['doctorName'] = $nameNew;
          $_SESSION['doctorPhone']= $phoneNoNew;
                        $_SESSION['doctorGender']= $genderNew;

        $name =$_SESSION['doctorName'];
         $phoneNo = $_SESSION['doctorPhone'];
        $gender = $_SESSION['doctorGender'];
        } else {
